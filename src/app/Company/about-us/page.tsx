    ...
    <div>
      ...
      <div className="py-16 lg:px-20 bg-white text-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mt-8">
            {/* Box 1 */}
            <div className="bg-[#2c90ba] text-black rounded-lg p-6 flex flex-col items-start text-left">
      ...
      <div className="py-16 px-4 bg-gray-100 text-black">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-6 mt-8">
          {/* Logo 1 */}
          <div className=" flex justify-center items-center p-4">
            <img src="/a3.1.png" alt="Company 1 Logo" className="w-32 h-auto" />
          </div>

          {/* Logo 2 */}
          <div className=" flex justify-center items-center p-4">
            <img src="/a3.2.png" alt="Company 2 Logo" className="w-32 h-auto" />
          </div>

          {/* Logo 3 */}
          <div className=" flex justify-center items-center p-4">
            <img src="/a3.3.png" alt="Company 3 Logo" className="w-32 h-auto" />
          </div>

          {/* Logo 4 */}
          <div className=" flex justify-center items-center p-4">
            <img src="/a3.4.png" alt="Company 4 Logo" className="w-32 h-auto" />
          </div>
        </div>
      </div>
    </div>
