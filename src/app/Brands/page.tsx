...
//   return (
//     <div>
//       {/* First Section: Image with Heading and Paragraph */}
...
//           </h1>
//           <p className="text-lg sm:text-sm md:text-xl lg:w-[500px] max-w-3xl">
...
//       {/* Second Section: Grey Background with Boxes */}
//       <section className="bg-gray-200 py-16">
//         {/* Paragraph in the center */}
//         <div className="text-center mb-12">
//           <p className="text-sm lg:w-[650px] lg:ml-75 text-gray-700">
...
//           {/* Box 1 */}
//           <div className="flex flex-col items-center bg-white border border-black rounded-lg p-6">
//             <div className="w-[320px] h-[42px] mb-4">
//               <Image
//                 src="/b2.1.png" // Replace with your logo path
//                 alt="Logo 1"
//                 width={320}
//                 height={42}
//                 objectFit="contain"
...
//             </p>
//             <button className="px-6 py-2 rounded-full text-white bg-gray-800 hover:bg-gray-500 transition duration-300">
//               Visit game in stock
//             </button>
//           </div>

//           {/* Box 2 (with Heading instead of Image) */}
//           <div className="flex flex-col items-center bg-white border border-black rounded-lg p-6">
//             <h2 className="text-2xl font-bold text-center mb-4 italic">
//               RARE SPAWN
//             </h2>
//             <p className="text-center text-sm text-gray-600 mb-4">
//               A short description of the brand and what it offers.
...
//           {/* Box 3 (Heading next to Logo) */}
//           <div className="flex flex-col items-center bg-white border border-black rounded-lg p-6">
//             <div className="w-[320px] h-[42px] mb-4">
//               <Image
//                 src="/b2.3n.png" // Replace with your logo path
//                 alt="Logo 1"
//                 width={320}
//                 height={42}
//                 objectFit="contain"
...
//           {/* Box 4 (with Heading instead of Image) */}
//           <div className="flex flex-col items-center bg-white border border-black rounded-lg p-6">
//             <h2 className="text-2xl font-bold text-center mb-4 italic">
//               RESPAWNDIRECT
//             </h2>
...
//             <div className="w-[320px] h-[42px] mb-4">
//               <Image
//                 src="/b2.5.png" // Replace with your logo path
//                 alt="Logo 5"
//                 width={320}
//                 height={42}
//                 objectFit="contain"
...
//             <div className="w-[320px] h-[42px] mb-4">
//               <Image
//                 src="/b2.6.png" // Replace with your logo path
//                 alt="Logo 6"
//                 width={320}
//                 height={42}
//                 objectFit="contain"
  ...
  return (
    <div>
      ...
      <section className="bg-gray-200 py-16">
        ...
        {/* Grid of 6 boxes */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 px-8 max-w-7xl mx-auto">
