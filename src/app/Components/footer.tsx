...
//           <h2 className="text-3xl font-display font-extrabold text-[#2c90ba] italic">
//             CHANNEL LINK
//           </h2>
      ...
      <div className="max-w-full mx-auto flex flex-col md:flex-row justify-between items-center space-y-8 md:space-y-0">
        ...
        <div className="mt-8 md:mt-0 w-full md:w-auto text-center md:text-right">
          ...
          >
            ...
            <button
              type="submit"
              className="bg-[#2c90ba] text-white px-6 py-2 rounded-full  hover:bg-blue-700 transition duration-300 -ml-10 lg:ml-4"
            >
              Subscribe
            </button>
          </form>
